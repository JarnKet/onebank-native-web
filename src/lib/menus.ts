...
export const menus: Record<string, MenuIcon> = {
  STATEMENT: { filename: 'ob-mn-statement.svg', name: t('Statement', 'ການເຄື່ອນໄຫວ', '银行对账单', 'Sao kê tài khoản') },
  ...
  TRANSFER: { filename: 'ob-mn-transfer.svg', name: t('Transfer', 'ໂອນເງິນ', '转账', 'Chuyển khoản') },
  ONEPAY: { filename: 'ob-mn-onepay.png', name: t('OnePay', null, null, null) },
  PHONE: { filename: 'ob-mn-phone.svg', name: t('Phone ', 'ຈ່າຍຄ່າໂທລະສັບ', '交电话费', 'Thanh toán tiền điện thoại') },
  ELECTRICITY: { filename: 'ob-mn-electricity.svg', name: t('Electricity ', 'ຈ່າຍຄ່າໄຟຟ້າ', '交电费', 'Điện') },
  WATER: { filename: 'ob-mn-water.svg', name: t('Water ', 'ຈ່າຍຄ່ານໍ້າ', '交水费', 'Thanh toán tiền nước') },
  ...
  ECHEQUE: { filename: 'ob-mn-echeque.svg', name: t('E-Cheque', null, null, null) },
  ...
  HISTORY: { filename: 'ob-mn-history.svg', name: t('Billing History', 'ປະຫວັດການຈ່າຍ', '支付记录', 'Lịch sử thanh toán') },
  ...
  LEASING: { filename: 'ob-mn-leasing.svg', name: t('Leasing ', 'ຈ່າຍຄ່າສິນເຊື່ອຕ່າງໆ', null, null) },
  ...
  IBANKSALARY: { filename: 'ib-logo.png', name: t('Salary', 'ໂອນເງິນເດືອນ', null, null) },
